...
### abslong
Para o *SSTF-CAD*, precisamos medir a distância entre duas requisições, para isso precisamos pegar o valor absoluto e retornar um tipo *long long int*, criamos a função abslong para esta tarefa.
